...
namespace eSDK_UC_AccountMgrDemo_Windows_CSharp
{
    internal class eSDKServiceHelper
    {
        ...
        public static CommentResponse editDepartment(DepartmentInfo info)
        {
            CommentResponse result = eSDKServiceHelper.CallService<CommentResponse>(ECConstUri.department_uri, HttpMethod.PUT, info);
            return result;
        }
        ...
        public static QueryDepartmentResponse queryDepartment(QyDepartmentInfo info)
        {
            string _uri = ECConstUri.department_uri + string.Format("?userId={0}&parentId={1}&pageCount={2}&pageNum={3}", info.userId,info.parentId,info.pageCount,info.pageNum);
            QueryDepartmentResponse result = eSDKServiceHelper.CallService<QueryDepartmentResponse>(_uri, HttpMethod.GET);
            return result;
        }
        #endregion 部门管理
        ...
        public static AddAcountResponse addAccount(AddAccountInfo info)
        {
            AddAcountResponse result = eSDKServiceHelper.CallService<AddAcountResponse>(ECConstUri.account_uri, HttpMethod.POST, info);
            return result;
        }
        ...
        public static CommentResponse addSipNumber(AddSIPInfo info)
        {
            CommentResponse result = eSDKServiceHelper.CallService<CommentResponse>(ECConstUri.sip_uri, HttpMethod.POST, info);
            return result;
        }

        public static CommentResponse editSipNumber(AddSIPInfo info)
        {
            CommentResponse result = eSDKServiceHelper.CallService<CommentResponse>(ECConstUri.sip_uri, HttpMethod.PUT, info);
            return result;
        }

        public static CommentResponse delSipNumber(DelSipNumber info)
        {
            CommentResponse result = eSDKServiceHelper.CallService<CommentResponse>(ECConstUri.delSip_uri, HttpMethod.POST, info);
            return result;
        }

        public static QuerySipResponse querySipNumber(QuerySipInfoList info)
        {
            QuerySipResponse result = eSDKServiceHelper.CallService<QuerySipResponse>(ECConstUri.querySip_uri, HttpMethod.POST, info);
            return result;
        }
        ...
        #region 通讯录查询接口
        public static QueryAddressResponse queryAddress(QueryAddressInfo info)
        {
            string _uri = ECConstUri.address_uri + string.Format("?account={0}&condition={1}&pageCount={2}&pageNum={3}", info.account, info.condition, info.pageCount, info.pageNum);
            QueryAddressResponse result = eSDKServiceHelper.CallService<QueryAddressResponse>(_uri, HttpMethod.GET);
            return result;
        }

        public static QueryPersonInfoResponse queryPersonInfo(string staffAccount)
        {
            string _uri = ECConstUri.person_info_uri + string.Format("?staffAccount={0}", staffAccount);
            QueryPersonInfoResponse result = eSDKServiceHelper.CallService<QueryPersonInfoResponse>(_uri, HttpMethod.GET);
            return result;
        }
        ...
        public static QueryEmployeeResponse queryEmployee(QueryEmployee info)
        {
            string _uri = ECConstUri.employee_uri + string.Format("?account={0}&condition={1}&pageCount={2}&pageNum={3}", info.account,info.condition, info.pageCount, info.pageNum);
            QueryEmployeeResponse result = eSDKServiceHelper.CallService<QueryEmployeeResponse>(_uri, HttpMethod.GET);
            return result;
        }
        #endregion
